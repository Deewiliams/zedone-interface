...
const Home = () => {
    return (
        ...
        {/* ****************Landing Page Navbars******************** */}
            ...
            <div className="p-8 ">
                <ul className="grid  gap-y-16 grid-cols-1 md:grid-cols-2 md:gap-x-4 md:gap-y-20 lg:grid lg:grid-cols-4 lg:gap-x-2">
                    <li className="bg-white rounded-lg shadow-lg"><div className="h-72 sm:h-24 md:h-96 lg:h-96">
                        ...
                        <li className="bg-white rounded-lg shadow-lg"><div className="h-80 lg:h-96">
                        ...
                        <li className="bg-white rounded-lg shadow-lg"><div className="h-72 lg:h-96">
