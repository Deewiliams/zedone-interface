      ...
      <div className="bg-gray-200 shadow-2xl p-4 w-2/3 rounded-lg">
        ...
        <form className="space-y-8">
          <ul className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-4 grid-flow-row gap-6">
            ...
            <Input
              placeholder="NRC/Passport No."
              type="text"
              value={nrcPassportNo}
              onChange={(event) => setNrcPassportNo(event.target.value)}
            />
            ...
            <Input
              ...
              value={pin}
              onChange={(event) =>
                SVGTextPositioningElement(event.target.value)
              }
            />
            ...
            />
            <Buttonprops button_name="Register" />
          </ul>
        </form>
        {fullName}
        {address}
