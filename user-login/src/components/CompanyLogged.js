    ...
    return (
        ...
        <div className="h-screen bg-gradient-to-tr from-white to-purple-500">
            <div className="flex flex-row items-center justify-between md:flex-row-reverse px-6 bg-purple-600 h-20 lg:h-28 shadow-2xl">
                <div>
                    <img className="p-4 w-16 md:hidden lg:hidden hover:bg-purple-100 cursor-pointer overflow-hidden" onClick={() => setShowMenu(!showMenu)} src={barmenu} />
                </div>
            ...
            {
                showMenu ? <div className="h-5/6 bg-white w-60 md:hidden lg:hidden">
                            ...
                            <div className="mt-52 space-x-4  text-red-500  "> 
                                ...
                                <h1 className="-mt-5 hover:text-gray-500 cursor-pointer">Like us on Facebook</h1>
                                <FaTwitter className="mr-10" />
                                <h1 className="-mt-5 hover:text-gray-500 cursor-pointer">Follow us on Twitter</h1>
                                <FaFacebookF className="mr-10"/>
                                <h1 className="-mt-5 hover:text-gray-500 cursor-pointer ">Give us Feedback</h1>
                            </div>
